...
class OverlappingOutputCheckpointedExperimentHandler(BaseHandler):
    ...
    def run(self, experiment: OverlappingOutputCheckpointedExperiment, name: typing.AnyStr, specification: Specification):
        ...
        if isinstance(result,OverlappingOutputCheckpointedExperimentReturnValue):
            self.checkpointed_experiment_handler.publish_progress(specification,(result.progress,result.max_iterations))
