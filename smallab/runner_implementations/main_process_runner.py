...
class MainRunner(AbstractRunner):
    ...
    def run(self, specifications_to_run: typing.List[typing.Dict], run_and_save_fn):
        completed_specifications = []
        failed_specifications = []
        exceptions = []
        for specification in tqdm(specifications_to_run,file=TqdmToLogger(logging.getLogger("smallab")), desc="Experiments", disable=not self.show_progress):
